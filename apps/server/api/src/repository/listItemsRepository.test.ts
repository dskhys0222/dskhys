...
describe('ListItems Repository', () => {
  ...
  describe('insertListItem', () => {
    it('should insert a new list item successfully', async () => {
      const result = await insertListItem(testOwnerId, 'test-key', 'test data');
  ...
  describe('findListItemByKey', () => {
    ...
    it('should return null for non-existent key', async () => {
      const result = await findListItemByKey('non-existent-key', testOwnerId);
    ...
    it('should not find items from different owners', async () => {
      ...
      // 自分のオーナーIDで検索
      const result = await findListItemByKey('other-owner-key', testOwnerId);
  ...
  describe('updateListItem', () => {
    it('should update an existing list item', async () => {
      ...
      // 更新されたことを確認
      const findResult = await findListItemByKey('update-key', testOwnerId);
  ...
  describe('deleteListItem', () => {
    it('should delete an existing list item', async () => {
      ...
      // アイテムを削除
      const deleteResult = await deleteListItem('delete-key', testOwnerId);
      ...
      // 削除されたことを確認
      const findResult = await findListItemByKey('delete-key', testOwnerId);
