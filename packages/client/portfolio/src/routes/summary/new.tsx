...
export const Route = createFileRoute('/summary/new')({
    component: NewCustomAggregationPage,
});
...
function NewCustomAggregationPage() {
    const navigate = useNavigate();
    const stocks = useStocksStore((state) => state.stocks);
    const addCustomAggregation = useCustomAggregationsStore(
        (state) => state.addCustomAggregation
    );
